...
const Index = () => {
  const socialLinks = [
    {
      href: "https://discord.com/users/1162693800590848030",
      label: "Discord",
      icon: <DiscordIcon className="w-5 h-5" />,
    },
    {
      href: "https://www.instagram.com/jedbillyb/",
      label: "Instagram",
      icon: <Instagram className="w-5 h-5" />,
    },
    {
      href: "mailto:jedbillyb@outlook.com",
      label: "Email",
      icon: <Mail className="w-5 h-5" />,
      external: false,
    },
    {
      href: "https://github.com/jedbillyb",
      label: "GitHub",
      icon: <Github className="w-5 h-5" />,
    },
    {
      href: "https://x.com/jedbillyb09",
      label: "X",
